...
const SettingsError = ({ error, onRetry }) => (
  <div className="flex justify-center items-center min-h-[400px]">
    <div className="bg-red-50 border border-red-200 rounded-lg p-8 max-w-md text-center">
      ...
      <p className="text-red-600 mb-4">{error?.message || 'An error occurred while loading settings'}</p>
      <button
        onClick={onRetry}
              ...
              {safeUser && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="text-xl font-semibold text-gray-900">{safeUser.name}</p>
                      <p className="text-gray-600">{safeUser.email}</p>
                      <p className="text-sm text-gray-500 mt-1 capitalize">Role: {safeUser.role?.replace(/[_-]/g, ' ')}</p>
                    </div>
                  </div>
                </div>
              )}
                    ...
                    {safeNotifications.emailNotifications !== undefined && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <button
                          ...
                          style={{ backgroundColor: safeNotifications.emailNotifications ? '#0f5841' : '#d1d5db' }}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                              safeNotifications.emailNotifications ? 'translate-x-6' : 'translate-x-1'
                            }`}
                          />
                        </button>
                      </div>
                    ...
                    {safeNotifications.inAppNotifications !== undefined && (
                      <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <button
                          ...
                          style={{ backgroundColor: safeNotifications.inAppNotifications ? '#0f5841' : '#d1d5db' }}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                              safeNotifications.inAppNotifications ? 'translate-x-6' : 'translate-x-1'
                            }`}
                          />
                        </button>
                      </div>
