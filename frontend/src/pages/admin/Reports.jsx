...
import {
  ...
  teamsQuery,
  tasksQuery,
} from "../../loader/admin/Reports.loader";
  ...
  return (
    <div>
      ...
      <div className="w-full bg-gray-200 rounded-full h-1.5">
        <div
          className={`${colors[color]} h-1.5 rounded-full`}
...
const Reports = () => {
  ...
  const isLoading =
    usersLoading || projectsLoading || teamsLoading || tasksLoading;
                  ...
                  {safeProjects.map((project) => (
                    <tr key={project.id}>
                      ...
                      <td className="px-4 py-3 text-sm">
                        {project.endDate || project.dueDate || "N/A"}
                      </td>
                    </tr>
                  ))}
                </tbody>
