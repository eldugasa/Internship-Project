...
// Create Team Modal Component - Separate to prevent re-renders
  ...
  <div className="flex justify-center items-center min-h-[400px]">
    <div className="bg-red-50 border border-red-200 rounded-lg p-8 max-w-md text-center">
      ...
      <p className="text-red-600 mb-4">
        {error?.message || "An error occurred while loading teams"}
      </p>
      <button
        onClick={onRetry}
  ...
  const handleDeleteTeam = async (teamId, e) => {
    ...
    try {
      ...
      if (err.message?.includes("has projects")) {
        alert(
          "Cannot delete team that has projects assigned. Please reassign projects first.",
        );
      } else if (err.message?.includes("has members")) {
        alert(
          "Cannot delete team that has members. Please remove all members first.",
        );
      } else {
        ...
        {([teamsData, usersData]) => {
          ...
          return (
            <div className="space-y-6">
              ...
              {/* Create Team Modal - Separate component */}
              <CreateTeamModal
