...
const NotificationBell = () => {
  ...
  // Get icon based on notification type (Admin specific)
  const getNotificationIcon = (type) => {
    switch(type) {
      ...
      case 'role_changed':
        return { icon: Shield, color: 'text-indigo-500', bg: 'bg-indigo-50' };
      default:
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          ...
                          {!notification.read && (
                            <span className="w-2 h-2 bg-[#0f5841] rounded-full"></span>
                          )}
                        </div>
