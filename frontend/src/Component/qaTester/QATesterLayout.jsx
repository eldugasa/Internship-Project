    ...
    <div className="flex h-screen bg-gray-50">
      ...
      {!isMobileMenuOpen && (
        <button
          ...
          style={{ background: `linear-gradient(to right, #4DA5AD, #4c1d95)` }}
        >
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search QA tasks..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#4DA5AD] focus:border-transparent text-sm"
                />
                {searchQuery && (
                  <button
                    type="button"
