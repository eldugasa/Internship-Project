...
const TeamMemberLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Mobile Menu Button - Only shows on left when menu is closed */}
      {!isMobileMenuOpen && (
        <button
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          {!sidebarCollapsed ? (
            <h1 className="text-2xl font-bold">
              <span style={{ color: '#0f5841' }}>Task</span>
              <span style={{ color: '#194f87' }}>Flow</span>
            </h1>
          ) : (
            <h1 className="text-2xl font-bold mx-auto lg:mx-0">
              <span style={{ color: '#0f5841' }}>T</span>
              <span style={{ color: '#194f87' }}>F</span>
            </h1>
          )}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-3">
          <div className="flex justify-between items-center">
            {/* Search */}
            <form onSubmit={handleSearch} className={`flex-1 max-w-md ${isMobileMenuOpen ? 'ml-14' : 'ml-14 lg:ml-0'}`}>
